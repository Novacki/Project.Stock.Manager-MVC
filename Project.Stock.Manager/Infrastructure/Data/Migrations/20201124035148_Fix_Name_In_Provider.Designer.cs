...
namespace Project.Stock.Manager.Infrastructure.Data.Migrations
{
    ...
    [Migration("20201124035148_Fix_Name_In_Provider")]
    partial class Fix_Name_In_Provider
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project.Stock.Manager.Infrastructure.Model.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Stock.Manager.Infrastructure.Model.Sell", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Stock.Manager.Infrastructure.Model.Sell", b =>
                {
                    b.HasOne("Project.Stock.Manager.Infrastructure.Model.Customer", "Customer")
                        .WithMany("Sells")
